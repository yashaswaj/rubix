...
public class TestBookKeeperMetrics
{
  ...
  {
    CacheConfig.setMetricsReporters(conf, BookkeeperMetricsReporter.JMX.name());
  ...
  {
    CacheConfig.setMetricsReporters(conf, BookkeeperMetricsReporter.STATSD.name());
  ...
  {
    CacheConfig.setMetricsReporters(conf, BookkeeperMetricsReporter.GANGLIA.name());
  ...
  {
    CacheConfig.setMetricsReporters(conf, Joiner.on(",").join(BookkeeperMetricsReporter.STATSD.name(), BookkeeperMetricsReporter.JMX.name()));
